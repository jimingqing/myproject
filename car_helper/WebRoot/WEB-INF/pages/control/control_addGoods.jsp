...
<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="100%"  border="0" cellpadding="0" cellspacing="1" class="blue_kuang" style="margin-top:7px;">
								...
								<tr align="left" valign="bottom" class="black_text_k5">
									...
									<td width="77%" bgcolor="#FFFFFF">
										<input type="text" name="price" id="price" class="txt_input" value="" size="5" maxlength="10"> 元
									</td>
								</tr>
...
<script type="text/javascript">
	...
	function actSubmit(){
		...
		if(confirm("确认添加商品信息！")){
			...
			doAjaxRequestWithFile("${ctx}/console/gd_addGoods.action", param, ["spicfile","lpicfile"], succCallBack, errCallBack);
		}
	}
