  ...
  <tr>
	...
	<!--查询标题开始-->
      <table width="500" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="25">&nbsp;</td>
          <td width="475" align="left" valign="bottom" class="black_blod" style="color:#fff;font-size:14px;font-weight:bold;">查询权限</td>
        </tr>
      </table>
	<!--查询标题结束-->
	...
	<div style="height:10px; width:auto;padding:10px;">
		<table id="header" width="auto" border=0 cellspacing="1" cellpadding="0" bgcolor="#C0C9E0" class="List">
			...
			<tr>
				...
				<td width="150" class="div">权限名称</td>
				<td width="80" class="div">权限级别</td>
				<td width="80" class="div">顺序编号</td>
				<td width="150" class="div">父权限名称</td>
				<td width="120" class="div">是否对操作员开放</td>
			...
			<tr id="nodata" class="none">
				<td colspan="9" align="center" class="font14-bold">无数据</td>
			</tr>
			</thead>
			...
			if(data.retCode == "0000"){
				if(data.content.length > 0){
					...
					$.each(data.content, function(index, item){
						...
						html += "<td align='center'>"+item.parentName+"</td>";
						if(item.isDefault == "Y"){
