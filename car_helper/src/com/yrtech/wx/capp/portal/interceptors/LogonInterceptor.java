...
public class LogonInterceptor extends AbstractInterceptor {
	...
	public String intercept(ActionInvocation invocation) throws Exception {
		...
		if (name.equals("cust_login") 
				|| name.equals("regist_registUser") 
				|| name.equals("user_qryDeptInfo")
				|| name.equals("login_page") ) {
			// 如果用户想登录，则使之通过
...
//				writeJson(outStr);
				...
				MerOperInfoVo user = (MerOperInfoVo) session.get(Constants.USER_INFOVO);
				if (user == null) {
