  ...
  <table width="100%"  border="0" cellpadding="0" cellspacing="1" class="blue_kuang" style="margin-top:7px;">
		<form>
								...
								<tr align="left" valign="bottom" class="black_text_k5">
									...
									<td width="20%" bgcolor="#FFFFFF">
										<input type="text" id="userName" name="userName" class="txt_input" value="">
									</td>
									<td width="10%" height="28" align="right" valign="bottom" bgcolor="#D9DFEE">
										用户余额：
									</td>
...
<!--查询区域外框开始结束-->
	...
	<div style="height:10px; width:auto;padding:10px;">
		<table id="header" width="1250" border=0 cellspacing="1" cellpadding="0" bgcolor="#C0C9E0" class="List">
			<thead>
			<tr>
				<td width="30" height="45" class="div">序号</td>
				<td width="120" class="div">所属公司</td>
				<td width="150" class="div">所在城市/区县</td>
				<td width="100" class="div">订单编号</td>
				<td width="80" class="div">持卡人姓名</td>
				<td width="80" class="div">手机号码</td>
				<td width="100" class="div">交易卡号</td>
				<td width="60" class="div">交易金额</td>
				<td width="80" class="div">交易方式</td>
				<td width="150" class="div">提交时间</td>
				<td width="60" class="div">交易状态</td>
				<td width="60" class="div">发货状态</td>
			...
			if(data.retCode == "0000"){
				...
				if(data.content.datalist.length > 0){
					...
					$.each(data.content.datalist, function(index, item){
						...
						html += "<td align='center'>"+item.acctName+"</td>";
						html += "<td align='center'>"+item.userCode+"</td>";
						html += "<td align='center'>**** "+item.acctNo+"</td>";
						html += "<td align='right'>"+item.ordAmtStr+"</td>";
						html += "<td align='center'>"+item.ordOrg+"</td>";
						html += "<td align='center'>"+item.createTime+"</td>";
						html += "<td align='center'>"+item.ordState+"</td>";
						html += "<td align='center'>"+item.shipState+"</td>";
						if(item.ordState!="成功"){
							html += "<td align='left'><a href='${ctx}/admin/qryOrdLogDetailPage.action?ordId="+item.id+"'>订单明细</a></td>";
						}else{
							html += "<td align='left'><a href='${ctx}/admin/qryOrdLogDetailPage.action?ordId="+item.id+"'>订单明细</a> | <a href='${ctx}/admin/orderDeliveryPage.action?ordId="+item.id+"'>订单发货</a></td>";
						}
						html += "</tr>";
					})
					$("#result").html(html);
